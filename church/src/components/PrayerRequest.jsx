...
const PrayerRequest = () => {
  ...
  const categories = [
    { id: "all", label: "All Prayers", icon: "fa-praying-hands", color: "amber" },
    { id: "personal", label: "Personal", icon: "fa-user", color: "blue" },
    { id: "family", label: "Family", icon: "fa-users", color: "green" },
    { id: "health", label: "Health & Healing", icon: "fa-heartbeat", color: "red" },
    { id: "work", label: "Work & Finances", icon: "fa-briefcase", color: "purple" },
    { id: "community", label: "Community", icon: "fa-city", color: "teal" },
    { id: "thanksgiving", label: "Thanksgiving", icon: "fa-hands", color: "orange" }
  ];
  ...
  const getCategoryIcon = (categoryId) => {
    ...
    return icons[categoryId] || "fa-praying-hands";
  };
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-amber-100/80 backdrop-blur-sm px-5 py-2 rounded-full mb-5 shadow-sm">
            <i className="fas fa-praying-hands text-amber-600 text-sm"></i>
          ...
          <h2 className="text-4xl md:text-6xl font-bold serif text-stone-800 mb-4">
            Prayer <span className="text-amber-600">Requests</span>
          </h2>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 border border-stone-100">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center">
                <i className="fas fa-pen-alt text-amber-600"></i>
              </div>
          ...
          <div>
            ...
            <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2">
              {filteredPrayers.length > 0 ? (
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center">
                          <i className={`fas ${getCategoryIcon(prayer.category)} text-amber-600 text-sm`}></i>
                        </div>
                        <div>
                ...
                <div className="text-center py-12 bg-white rounded-xl">
                  <i className="fas fa-praying-hands text-4xl text-stone-300 mb-3"></i>
            ...
            <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
              <div className="flex items-start gap-3">
                <i className="fas fa-users text-amber-600 text-lg"></i>
                <div>
