        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {categories.map((cat) => (
            ...
            >
              ...
              <span className={`text-xs px-1.5 py-0.5 rounded-full ${selectedCategory === cat.id ? "bg-white/20" : "bg-amber-100 text-amber-700"
                }`}>
                {cat.count}
              </span>
            </button>
              ...
              <div className="relative overflow-hidden">
                  ...
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <div className="flex items-center justify-between text-xs text-stone-500">
                      <div className="flex items-center gap-3">
                        <span className="flex items-center gap-1"><FontAwesomeIcon icon={faHeart} className="text-amber-500" /> {image.likes}</span>
                        <span className="flex items-center gap-1"><FontAwesomeIcon icon={faComment} className="text-amber-500" /> {image.comments}</span>
                      </div>
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform scale-0 group-hover:scale-100">
                  <div className="w-12 h-12 bg-white/90 rounded-full flex items-center justify-center shadow-lg">
                    <FontAwesomeIcon icon={faSearchPlus} className="text-amber-600 text-xl" />
                  </div>
                </div>
              </div>
            </div>
